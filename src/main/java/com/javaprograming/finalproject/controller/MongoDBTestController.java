...
import com.javaprograming.finalproject.service.MongoDBTestService;
...
public class MongoDBTestController {
    ...
    public String findTestData(@RequestParam String name) {
        return mongoDBTestService.selectUser(name);
    }

    @GetMapping(value = "/save")
    public String saveTestData(@RequestParam String name, @RequestParam int age) {
