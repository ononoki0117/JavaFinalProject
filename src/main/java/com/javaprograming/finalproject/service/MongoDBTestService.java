...
import com.javaprograming.finalproject.model.MongoDBTestModel;
import com.javaprograming.finalproject.model.MongoDBTestRepository;
...
public class MongoDBTestService {
    ...
    public String selectUser(String name) {
        ...
        try {
            if (mongoDBTestRepository.findByName(name) == null) {
                ...
                return mapper.writeValueAsString(mongoDBTestRepository.findByName(name));
            }
    ...
    public void saveUser(String name, int age) {
        ...
        if (mongoDBTestRepository.findByName(name) != null) {
            log.info("[Service] user name : {} already exist!!", name);
